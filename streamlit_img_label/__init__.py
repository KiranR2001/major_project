...
if not _RELEASE:
    ...
    _component_func = components.declare_component("gif_img", path=build_dir)


def gif_img(resized_img, box_color="blue", rects=[], key=None):
    """Create a new instance of "gif_img".
...
if not _RELEASE:
    ...
    rects = gif_img(resized_img, box_color="red", rects=resized_rects)
